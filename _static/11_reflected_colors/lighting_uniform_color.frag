...
void main() {
  ...
  ambient_color = u_Ambient_intensities * vec3(u_Model_color);
  ...
  diffuse_color = vec3(u_Model_color) * u_Light_color * cos_angle;
  ...
  specular_color = u_Light_color * vec3(u_Model_color) * cos_angle;
  ...
  gl_FragColor = vec4(color, u_Model_color.a);
}
